...
BULLMQ_DEFAULT_MAX_ATTEMPTS: int = int(
    os.getenv("SYNTARO_BULLMQ_MAX_ATTEMPTS", "5")
)
...
BULLMQ_JOB_TIMEOUT_SECONDS: int = int(
    os.getenv("SYNTARO_BULLMQ_JOB_TIMEOUT_SECONDS", "600")
)
...
BULLMQ_STALLED_INTERVAL_SECONDS: int = int(
    os.getenv("SYNTARO_BULLMQ_STALLED_INTERVAL_SECONDS", "45")
)
...
SUPERVISOR_MAX_RESTARTS: int = int(
    os.getenv("SYNTARO_SUPERVISOR_MAX_RESTARTS", "3")
)
...
SUPERVISOR_RESTART_WINDOW_SECONDS: int = int(
    os.getenv("SYNTARO_SUPERVISOR_RESTART_WINDOW_SECONDS", "60")
)

# Delay (seconds) between automatic restart attempts.
SUPERVISOR_RESTART_DELAY_SECONDS: int = int(
    os.getenv("SYNTARO_SUPERVISOR_RESTART_DELAY_SECONDS", "5")
)
...
SUPERVISOR_PRIORITY_AGENT: int = int(
    os.getenv("SYNTARO_SUPERVISOR_PRIORITY_AGENT", "100")
)
SUPERVISOR_PRIORITY_HOUSEKEEPING: int = int(
    os.getenv("SYNTARO_SUPERVISOR_PRIORITY_HOUSEKEEPING", "200")
)
...
SUPERVISOR_AUTOSTART: bool = (
    os.getenv("SYNTARO_SUPERVISOR_AUTOSTART", "true").lower() == "true"
)
...
OTEL_SERVICE_NAME: str = os.getenv(
    "OTEL_SERVICE_NAME", "syntaro-runaway"
)
...
OTEL_SPAN_NAME_RUNAWAY: str = os.getenv(
    "SYNTARO_OTEL_SPAN_RUNAWAY", "syntaro.runaway.execution"
)
