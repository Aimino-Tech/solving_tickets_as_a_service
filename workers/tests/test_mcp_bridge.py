...
class TestListIssues:
    ...
    async def test_list_all(self, pop_reg):
        from stas_mcp.server import _list_issues_handler
...
class TestSearch:
    ...
    async def test_query(self, pop_reg):
        from stas_mcp.server import _search_codebase_handler
...
class TestIssueResource:
    ...
    async def test_by_url(self, pop_reg):
        from stas_mcp.server import _get_issue_resource_handler
...
class TestServerReg:
    ...
    def test_resources(self):
        ...
        assert "stas://issues/{issue_id}" in uris
