...
task_routes = {
    "tasks.triage.*": {"queue": "stas.agents.triage"},
    "tasks.agent.*": {"queue": "stas.agents.dispatch"},
    "tasks.sandbox.*": {"queue": "stas.agents.sandbox"},
    "tasks.verification.*": {"queue": "stas.agents.verification"},
    "tasks.pr_creation.*": {"queue": "stas.agents.pr_creation"},
    "tasks.notifications.*": {"queue": "stas.agents.notifications"},
}
