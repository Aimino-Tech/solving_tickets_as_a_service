        ...
        <div className="mx-auto max-w-2xl">
          ...
          <form onSubmit={submit} className="mt-8 space-y-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                <label htmlFor="ep-name" className="block text-sm font-medium text-gray-700">Name *</label>
                <input id="ep-name" type="text" required value={f.name} onChange={e => h('name', e.target.value)} className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm" placeholder="Jane Smith" />
              </div>
              <div>
                <label htmlFor="ep-email" className="block text-sm font-medium text-gray-700">Email *</label>
                <input id="ep-email" type="email" required value={f.email} onChange={e => h('email', e.target.value)} className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm" placeholder="jane@company.com" />
              </div>
            </div>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                <label htmlFor="ep-company" className="block text-sm font-medium text-gray-700">Company *</label>
                <input id="ep-company" type="text" required value={f.company} onChange={e => h('company', e.target.value)} className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm" placeholder="Acme Corp" />
              </div>
              <div>
                <label htmlFor="ep-teamSize" className="block text-sm font-medium text-gray-700">Team Size</label>
                <select id="ep-teamSize" value={f.teamSize} onChange={e => h('teamSize', e.target.value)} className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm">
            ...
            <div>
              <label htmlFor="ep-message" className="block text-sm font-medium text-gray-700">Message *</label>
              <textarea id="ep-message" required rows={4} value={f.message} onChange={e => h('message', e.target.value)} className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-sm" placeholder="Tell us about your needs..." />
            </div>
