  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Your code is your intellectual property. We built STAS with a security-first architecture so you never have to compromise on trust.</p>
      </div>
