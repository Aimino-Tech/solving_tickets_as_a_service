    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <label className="flex items-center gap-3">
          ...
          />
          <span className="text-sm text-gray-600">Skip this for now &mdash; I&apos;ll set up a team later</span>
        </label>

        <div className="flex items-center gap-4 pt-4">
          <button type="submit" disabled={!teamName.trim() && !skipTeam} className="btn-primary">
