    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-500">
          STAS needs access to your repositories so it can fix issues and open pull requests.
        </p>
      </div>

      <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
        <h3 className="text-lg font-semibold text-gray-900">Step 1: Install the App</h3>
