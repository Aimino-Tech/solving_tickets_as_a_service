...
const NEXT_STEPS = [
  {
    ...
    description: 'Add the label <code>stas:fix</code> to any GitHub issue to trigger STAS.',
...
export default function Complete() {
  ...
  return (
    <div className="text-center">
      ...
      <button
        onClick={() => navigate('/')}
        className="mt-8 text-sm font-medium text-brand-600 hover:text-brand-500"
      >
        Go to Dashboard →
      </button>
    </div>
