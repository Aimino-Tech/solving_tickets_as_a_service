    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="card">
        <div className="flex items-start justify-between">
          ...
          <span className={`shrink-0 rounded-full border px-3 py-1 text-xs font-semibold ${statusStyles[run.status] || 'text-gray-600 bg-gray-50 border-gray-200'}`}>
            {run.status}
          </span>
        </div>
      </div>
      ...
      {run.confidence && (
        <div className="card">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-500">Confidence Score</h3>
      ...
      {diff && (
        <div className="card">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-500">Changes</h3>
      ...
      {run.testOutput && (
        <div className="card">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-500">Test Results</h3>
          ...
          {run.testOutput.length > 5000 && (
            <p className="mt-2 text-xs text-gray-400">(truncated to 5000 characters)</p>
          )}
        </div>
      )}
      ...
      <div className="rounded-xl border border-gray-200 bg-brand-50 p-6">
        <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:text-left">
          <div className="flex-1">
            <h3 className="text-base font-semibold text-gray-900">Share this run</h3>
      ...
      <div className="rounded-xl border border-brand-200 bg-gradient-to-br from-brand-50 to-white p-8 text-center">
