...
export default function Home() {
  useEffect(() => { document.title = 'STAS — Solving Tickets As A Service | AI-Powered GitHub Automation'; }, []);
  return (<>
    <section className="hero">
      <div className="hero-content">
        ...
        <p className="sub animate-in animate-in-d3">
          <strong>STAS</strong> is an open-source GitHub bot that takes a labeled issue, investigates your codebase, writes a fix, runs your tests, and opens a PR. Backed by <strong>OpenCode</strong> — the 162K★ open-source coding agent.
        </p>
        <div className="btn-group animate-in animate-in-d4">
          <a href="https://github.com/apps/stasgithub1/installations/new" className="btn btn-primary" data-track="hero-install">Install GitHub App →</a>
    ...
    <section className="section">
      ...
      <div className="bento-grid">
        ...
        <div className="bento-item">
          ...
          <h3>$1.5M/Year</h3>
          <p>Average enterprise loses $1.5M/year in developer context-switching costs. <span className="text-gold">STAS eliminates that.</span></p>
        </div>
        <div className="bento-item">
          <div className="bento-icon">🔁</div>
          <h3>The STAS Way</h3>
          <p>Label an issue with <code>stas:fix</code>. STAS handles investigation, fix, tests, and PR — in <strong>under 4 minutes</strong>. You review and merge.</p>
        </div>
      </div>
    </section>
    ...
    <section className="section" id="how-it-works">
      ...
      <div className="steps">
        {[
          { icon: '🔖', title: 'Label the Issue', desc: 'Add the stas:fix label to any GitHub issue. STAS picks it up automatically via webhook.', cls: 'gold' },
          { icon: '🔍', title: 'Investigate', desc: 'STAS reads the issue, explores your codebase, reproduces the bug, and identifies the root cause.', cls: 'cyan' },
    ...
    <section className="section">
      <div className="section-header">
        ...
        <p className="sub">STAS processes thousands of tickets every week for teams of all sizes.</p>
      </div>
      <div className="testimonials">
        {[
          { avatar: 'SK', name: 'Sarah Kim', role: 'Lead Engineer, OpenSource Co.', text: 'STAS basically eliminated our bug backlog in two weeks. Our OSS maintainers can finally focus on features instead of triage.' },
          ...
          { avatar: 'AL', name: 'Aiko Tanaka', role: 'VP Engineering, ScaleUp Inc.', text: 'We measured: STAS saves each developer 5+ hours per week. That\'s real money. The ROI calculation was trivial.' },
        ].map((t, i) => (
    ...
    <section className="section" id="faq">
      ...
      <div className="faq-list">
        {[
          { q: 'Which CI systems does STAS support?', a: 'STAS runs your existing test suite inside an isolated sandbox. It works with any CI system — GitHub Actions, GitLab CI, Jenkins, or just a Makefile.' },
          ...
          { q: 'How much does STAS cost?', a: <>STAS is free for public repos. See our <Link to="/pricing">pricing page</Link> for private repos and teams.</> },
          { q: 'Can I run STAS on-premise?', a: <>Yes, STAS is fully open-source and can be self-hosted. See our <Link to="/docs">documentation</Link>.</> },
        ].map((f, i) => (
    ...
    <section className="cta-section">
      ...
      <p className="sub">Install the STAS GitHub App in under 30 seconds. No config. No onboarding calls.</p>
      <div className="btn-group">
        <a href="https://github.com/apps/stasgithub1/installations/new" className="btn btn-primary btn-lg" data-track="cta-install">Install the GitHub App →</a>
