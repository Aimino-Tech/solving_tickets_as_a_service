...
echo "=== SYNTARO Uptime Setup ==="
u "SYNTARO /health" "https://api.syntaro.io/health" 30 '["us-east-1","eu-west-1","ap-southeast-1"]'
u "SYNTARO /health/queue" "https://api.syntaro.io/health/queue" 60 '["us-east-1","eu-west-1"]'
u "SYNTARO /api/pricing" "https://api.syntaro.io/api/pricing" 300 '["us-east-1","eu-west-1"]'
u "SYNTARO Website" "https://syntaro.io/" 300 '["us-east-1","eu-west-1","ap-southeast-1"]'
uh "SYNTARO Synthetic E2E" "https://api.syntaro.io/monitoring/synthetic-heartbeat" 300 120
echo "=== Done ==="
