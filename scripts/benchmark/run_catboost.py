#!/usr/bin/env python3
"""CatBoost model runner for tabular-mcp benchmark.

Usage: echo <csv_data> | python3 run_catboost.py --target <col> --format json
"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="CatBoost benchmark runner")
