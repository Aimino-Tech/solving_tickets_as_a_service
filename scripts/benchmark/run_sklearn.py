#!/usr/bin/env python3
"""scikit-learn model runner for tabular-mcp benchmark.

Usage: echo <csv_data> | python3 run_sklearn.py --target <col> --format json
"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="sklearn benchmark runner")
