...
- **Asset documentation** (`stas/marketplace-assets/README.md`) — Logo 120×120, screenshots 1280×640, demo GIF requirements
...
### 3. Demo Repository
- **Script** (`scripts/create-demo-repo.sh`) — Creates `stas-demo` repo with 4 pre-configured issues labeled `stas:fix`:
