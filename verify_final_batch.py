...
def main():
    ...
    # Skip first 98 (already checked)
    check_items = items[98:]
    print(f"Checking final {len(check_items)} unique URLs...")
    ...
    print(f"\n{'='*60}")
    print(f"FINAL BATCH RESULTS: {live} live, {len(removed)} removed, {errors} errors")
    print(f"\nGRAND TOTAL: {98 + live} live, {len(removed)} removed, {errors} errors")
