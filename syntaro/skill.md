...
# SYNTARO Skill — Automated Issue Fixing

The SYNTARO skill enables any OpenCode or OpenClaw agent to submit GitHub issues to the SYNTARO API for automated fix generation. SYNTARO investigates the codebase, writes a fix, runs regression tests, and opens a PR.

## Prerequisites

1. **SYNTARO API Key** — Subscribe at [RapidAPI Marketplace](https://rapidapi.com/aimino/api/syntaro-api) or self-host
...
SYNTARO_API_URL=https://api.syntaro.io
...
```json
{
  "jobId": "syntaro_job_abc123",
  "status": "pending",
  "estimatedWaitSeconds": 120,
  "pollUrl": "https://api.syntaro.io/api/fix/syntaro_job_abc123"
}
```
...
```json
{
  ...
  "branch": "syntaro-fix/login-validation-bug",
...
Get public SYNTARO benchmark evaluation results showing pass rates across different benchmarks.
...
|-------|-------|-----------|
| `invalid_api_key` | Missing or invalid SYNTARO API key | Check `SYNTARO_API_KEY` env var |
...
- **RapidAPI Marketplace**: https://rapidapi.com/aimino/api/syntaro-api
