...
def main():
    ...
    # Skip first 87 (already checked in batches 1+2)
    check_items = items[87:]
    print(f"Checking remaining {len(check_items)} unique URLs...")
    ...
    print(f"\n{'='*60}")
    print(f"BATCH 3 RESULTS: {live} live, {len(removed)} removed, {errors} errors")
    print(f"\nGRAND TOTAL: {87 + live} live, {len(removed)} removed, {errors} errors")
