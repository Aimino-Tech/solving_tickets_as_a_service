...
def main():
    ...
    check_items = items[:80]
    print(f"Checking {len(check_items)} unique URLs via CDP on port {CDP_PORT}...")
    ...
    print(f"\n{'='*60}")
    print(f"FINAL RESULTS: {live} live, {len(removed)} removed, {errors} errors")
    ...
    if removed:
        ...
        print("\nNo removed comments found among the checked URLs.")
