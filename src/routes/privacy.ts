...
/**
 * GET /api/v1/privacy/export — data portability (GDPR Art. 20).
...
/**
 * DELETE /api/v1/privacy/data — right to erasure (GDPR Art. 17).
...
/**
 * POST /api/v1/privacy/anonymize — data anonymization tool.
...
/**
 * GET /api/v1/privacy/consent — cookie-consent preferences.
...
/**
 * PUT /api/v1/privacy/consent — save a cookie-consent preference.
