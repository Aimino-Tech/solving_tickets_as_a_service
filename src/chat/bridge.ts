...
export type BridgeMessage =
  | { kind: 'instruction'; traceId: string; instruction: string; memorySnapshot: AgentMemory; threadRef: ThreadRef; workType: 'short' | 'long' }
...
const WORK_VERBS = [
  'fix', 'bug', 'issue', 'pr', 'pull request', 'ticket', 'create',
  'implement', 'refactor', 'optimize', 'review', 'migrate', 'test',
  'write', 'add', 'update', 'change', 'investigate', 'diagnose',
];
