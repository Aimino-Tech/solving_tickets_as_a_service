...
describe('github/messages', () => {
  ...
  describe('buildPRBody', () => {
    ...
    it('includes "Branch" section', () => {
      ...
      expect(body).toContain('syntaro/fix-42');
    });
    ...
    it('includes AI-generated fix attribution', () => {
      const body = buildPRBody(prBodyParams);
      expect(body).toContain('AI-generated fix');
      expect(body).toContain('This fix was generated by SYNTARO AI');
    });

    it('includes bot attribution', () => {
      const body = buildPRBody(prBodyParams);
      expect(body).toContain('SYNTARO');
    });
